        ...
        <div className="mx-30 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8">
          {getTeamMembers().map((member, idx) => {
            ...
            return (
              <div
                key={idx}
                className="cursor-pointer border border-neutral-700 rounded-lg transition-transform duration-300 hover:-translate-y-2 flex flex-col h-[22.5rem]
                shadow-[0px_0px_0px_1px_rgba(9,9,11,0.07),0px_2px_2px_0px_rgba(9,9,11,0.05)]
              bg-zinc-900 dark:shadow-[0px_0px_0px_1px_rgba(255,255,255,0.1)]
